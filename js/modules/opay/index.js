/**
 * OPay Platform Module
 * OPay invoice processing implementation
 */

import { OpayCrypto } from './crypto.js';
import { OpayCarrierProvider } from './carrier.js';
import { OpayCreateFunction } from './functions/create.js';
import { OpayVoidFunction } from './functions/void.js';
import { EVENTS } from '../../core/events.js';

export class OpayPlatform {
  constructor(core) {
    this.crypto = new OpayCrypto();
    this.carrierProvider = new OpayCarrierProvider();
    this.eventBus = core.eventBus;

    this.name = 'opay';
    this.displayName = "O'Pay";
    ...
    this.functions = {
      create: new OpayCreateFunction(this),
      void: new OpayVoidFunction(this)
    };
