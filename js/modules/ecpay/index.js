/**
 * ECPay Platform Module
 * ECPay invoice processing implementation
 */

import { EcpayCrypto } from './crypto.js';
import { EcpayCarrierProvider } from './carrier.js';
import { EcpayCreateFunction } from './functions/create.js';
import { EcpayVoidFunction } from './functions/void.js';
import { EVENTS } from '../../core/events.js';

export class EcpayPlatform {
  constructor(core) {
    this.crypto = new EcpayCrypto();
    this.carrierProvider = new EcpayCarrierProvider();
    this.eventBus = core.eventBus;

    this.name = 'ecpay';
    this.displayName = 'ECPay';
    ...
    this.functions = {
      create: new EcpayCreateFunction(this),
      void: new EcpayVoidFunction(this)
    };
