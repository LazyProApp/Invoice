/**
 * Amego Platform Module
 * Amego invoice processing implementation
 */

import { AmegoCrypto } from './crypto.js';
import { AmegoCarrierProvider } from './carrier.js';
import { AmegoCreateFunction } from './functions/create.js';
import { AmegoVoidFunction } from './functions/void.js';
import { EVENTS } from '../../core/events.js';

export class AmegoPlatform {
  constructor(core) {
    this.crypto = new AmegoCrypto();
    this.carrierProvider = new AmegoCarrierProvider();
    this.eventBus = core.eventBus;

    this.name = 'amego';
    this.displayName = 'Amego';
    ...
    this.functions = {
      create: new AmegoCreateFunction(this),
      void: new AmegoVoidFunction(this)
    };
